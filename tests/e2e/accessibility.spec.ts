...
test.describe('screen reader smoke', () => {
    test('home exposes landmarks, a single h1 and named controls', async ({page}) => {
    ...
    test('post has a labelled table-of-contents landmark', async ({page}) => {
...
test.describe('keyboard', () => {
    test('skip link is the first stop and focuses main', async ({page}) => {
        await gotoHydrated(page, '/')
    ...
    test('mobile navigation is reachable and operable', async ({page}) => {
...
test.describe('reduced motion', () => {
    ...
    test('all revealed content is immediately visible', async ({page}) => {
        ...
        const result = await page.evaluate(() => {
            const targets = [...document.querySelectorAll('.reveal, .reveal-text, .reveal-mask')]
            return {
...
test.describe('no JavaScript', () => {
    ...
    test('home still renders its core content', async ({page}) => {
        await page.goto('/')
    ...
    test('post still renders its body', async ({page}) => {
