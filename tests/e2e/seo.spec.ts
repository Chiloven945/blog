...
test.describe('feeds and sitemap', () => {
    test('serves the RSS feed and its legacy alias', async ({request}) => {
    ...
    test('serves a sitemap index with locale sitemaps', async ({request}) => {
    ...
    test('emits canonical and hreflang links on posts', async ({page}) => {
